...
public class Modelcuttermilitarised<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cuttermilitarised"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone13 = partdefinition.addOrReplaceChild("bone13",
				CubeListBuilder.create().texOffs(211, 108).mirror()
						.addBox(0.0F, -62.0F, -12.0F, 0.0F, 18.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(120, 0).addBox(-0.625F, -25.0F, 27.0F, 1.0F, 1.0F, 24.0F, new CubeDeformation(0.0F))
						.texOffs(177, 169).addBox(-13.0F, -59.0F, 1.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(178, 169).addBox(-13.0F, -47.5F, 1.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(177, 169).addBox(-13.0F, -59.0F, 25.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(178, 169).addBox(-13.0F, -47.5F, 25.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = bone13.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 58)
						.addBox(-17.0F, -5.425F, -0.325F, 34.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 58)
						.addBox(-17.0F, -5.425F, -24.325F, 34.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = bone13.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(86, 227)
				.addBox(-13.0F, 19.784F, -11.2137F, 26.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(86, 227)
				.addBox(-13.0F, 19.784F, -35.2137F, 26.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -31.0F, 35.0F, 0.0F, 0.0F, -3.1416F));

		PartDefinition cube_r9 = bone13.addOrReplaceChild("cube_r9",
		...
		PartDefinition cube_r11 = bone13.addOrReplaceChild("cube_r11",
		...
		PartDefinition cube_r12 = bone13.addOrReplaceChild("cube_r12",
		...
		PartDefinition cube_r14 = bone13.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(68, 58).addBox(-17.0F, -3.992F, 0.0261F, 34.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -25.9875F, 0.3625F, 0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r15 = bone13.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(0, 66).addBox(-17.0F, -0.008F, 0.0261F, 34.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -41.825F, 0.3875F, -0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r16 = bone13.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(68, 62).addBox(-17.0F, -0.5F, -0.25F, 34.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -43.075F, 1.275F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r17 = bone13.addOrReplaceChild("cube_r17",
		...
		PartDefinition cube_r18 = bone13.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(86, 231).addBox(-13.0F, -21.4738F, -7.5942F, 26.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = bone13.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(86, 223).addBox(-13.0F, -20.7441F, -20.7238F, 26.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -31.0F, 11.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r21 = bone13.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(156, 56).addBox(-0.875F, -19.5F, -18.0F, 1.0F, 1.0F, 36.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.125F, -24.5F, 2.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r22 = bone13.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(156, 56).addBox(0.125F, -0.5F, -18.0F, 1.0F, 1.0F, 36.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.125F, -24.5F, 1.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r23 = bone13.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(0, 200)
						.addBox(0.0F, -25.0F, -35.5F, 0.0F, 18.0F, 22.0F, new CubeDeformation(0.0F)).texOffs(211, 108)
						.addBox(0.0F, -25.0F, -52.0F, 0.0F, 18.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(0.0F, -7.0F, -61.0F, 0.0F, 31.0F, 75.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition flag = partdefinition.addOrReplaceChild("flag",
				CubeListBuilder.create().texOffs(34, 32)
						.addBox(0.1289F, -1.5F, 0.9009F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 31)
						.addBox(0.1289F, -1.5F, -4.9116F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.3789F, -41.0F, -30.8384F));

		PartDefinition cube_r24 = flag.addOrReplaceChild("cube_r24",
		...
		PartDefinition cube_r25 = flag.addOrReplaceChild("cube_r25",
		...
		PartDefinition wheel = partdefinition.addOrReplaceChild("wheel", CubeListBuilder.create().texOffs(183, 222)
				.addBox(-4.0F, -4.0F, -5.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition mast2 = partdefinition.addOrReplaceChild("mast2", CubeListBuilder.create().texOffs(18, 16)
				.addBox(-0.75F, -57.0F, -23.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = bone11.addOrReplaceChild(
				"cube_r27", CubeListBuilder.create().texOffs(155, 114).addBox(11.5208F, -21.5F, 11.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r28 = bone11.addOrReplaceChild(
				"cube_r28", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -16.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = bone12.addOrReplaceChild(
				"cube_r29", CubeListBuilder.create().texOffs(147, 114).addBox(11.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r30 = bone12.addOrReplaceChild(
				"cube_r30", CubeListBuilder.create().texOffs(151, 114).addBox(-16.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r31 = bone14.addOrReplaceChild(
				"cube_r31", CubeListBuilder.create().texOffs(76, 106).addBox(-12.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r32 = bone14.addOrReplaceChild(
				"cube_r32", CubeListBuilder.create().texOffs(109, 0).addBox(-17.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r33 = bone14
				.addOrReplaceChild("cube_r33",
						CubeListBuilder.create().texOffs(138, 0).addBox(0.15F, -21.5F, 17.0625F, 1.0F, 18.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r35 = bone21.addOrReplaceChild(
				"cube_r35", CubeListBuilder.create().texOffs(155, 114).addBox(11.5208F, -21.5F, 11.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r36 = bone21.addOrReplaceChild(
				"cube_r36", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -16.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r37 = bone22.addOrReplaceChild(
				"cube_r37", CubeListBuilder.create().texOffs(147, 114).addBox(11.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r38 = bone22.addOrReplaceChild(
				"cube_r38", CubeListBuilder.create().texOffs(151, 114).addBox(-16.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r39 = bone23.addOrReplaceChild(
				"cube_r39", CubeListBuilder.create().texOffs(76, 106).addBox(-12.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r40 = bone23.addOrReplaceChild(
				"cube_r40", CubeListBuilder.create().texOffs(109, 0).addBox(-17.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r41 = bone23
				.addOrReplaceChild("cube_r41",
						CubeListBuilder.create().texOffs(138, 0).addBox(0.15F, -21.5F, 17.0625F, 1.0F, 18.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));

		PartDefinition bone24 = mast2.addOrReplaceChild("bone24", CubeListBuilder.create(),
				PartPose.offset(0.0F, -31.5F, -30.1569F));

		PartDefinition cube_r42 = bone24.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(163, 114).addBox(-0.5F, -12.5F, -1.0F, 1.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -9.0F, -17.0F, 0.0F, -2.3562F, 0.0F));
		...
		PartDefinition cube_r43 = bone25.addOrReplaceChild(
				"cube_r43", CubeListBuilder.create().texOffs(155, 114).addBox(11.5208F, -21.5F, 11.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r44 = bone25.addOrReplaceChild(
				"cube_r44", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -16.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r45 = bone26.addOrReplaceChild(
				"cube_r45", CubeListBuilder.create().texOffs(147, 114).addBox(11.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r46 = bone26.addOrReplaceChild(
				"cube_r46", CubeListBuilder.create().texOffs(151, 114).addBox(-16.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r47 = bone27.addOrReplaceChild(
				"cube_r47", CubeListBuilder.create().texOffs(76, 106).addBox(-12.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r48 = bone27.addOrReplaceChild(
				"cube_r48", CubeListBuilder.create().texOffs(109, 0).addBox(-17.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r49 = bone27
		...
		PartDefinition cube_r50 = bone15.addOrReplaceChild("cube_r50",
		...
		PartDefinition cube_r51 = bone16.addOrReplaceChild(
				"cube_r51", CubeListBuilder.create().texOffs(16, 106).addBox(11.5208F, -21.5F, 11.0208F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r52 = bone16.addOrReplaceChild(
				"cube_r52", CubeListBuilder.create().texOffs(29, 106).addBox(0.15F, -21.5F, -16.9375F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r53 = bone17.addOrReplaceChild(
				"cube_r53", CubeListBuilder.create().texOffs(8, 106).addBox(11.5208F, -21.5F, -13.0208F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r54 = bone17.addOrReplaceChild(
				"cube_r54", CubeListBuilder.create().texOffs(12, 106).addBox(-16.85F, -21.5F, 0.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r55 = bone18.addOrReplaceChild(
				"cube_r55", CubeListBuilder.create().texOffs(48, 0).addBox(-12.5208F, -21.5F, -13.0208F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r56 = bone18.addOrReplaceChild(
				"cube_r56", CubeListBuilder.create().texOffs(0, 106).addBox(-17.3625F, -21.5F, -1.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r57 = bone18
				.addOrReplaceChild("cube_r57",
						CubeListBuilder.create().texOffs(4, 106).addBox(0.15F, -21.5F, 17.0625F, 1.0F, 22.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r58 = chestlid.addOrReplaceChild("cube_r58",
				CubeListBuilder.create().texOffs(154, 213).addBox(-7.0438F, -21.9519F, -2.3138F, 8.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.0626F, -4.1548F, -0.9948F, 0.0F, 0.0F));

		PartDefinition cube_r59 = chestlid.addOrReplaceChild("cube_r59",
				CubeListBuilder.create().texOffs(154, 213).addBox(-7.0338F, 2.5379F, 17.277F, 8.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.0626F, 0.8452F, 0.9905F, 0.0F, 0.0F));

		PartDefinition cube_r60 = chestlid.addOrReplaceChild("cube_r60", CubeListBuilder.create().texOffs(157, 209)
				.addBox(-1.9538F, 17.4638F, -3.259F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(157, 209)
				.addBox(-7.1538F, 17.4638F, -3.259F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.01F, 0.5626F, -1.6548F, 2.3562F, 0.0F, 0.0F));

		PartDefinition cube_r61 = chestlid.addOrReplaceChild("cube_r61",
				CubeListBuilder.create().texOffs(172, 217).addBox(-7.0438F, 17.616F, 3.5565F, 8.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.01F, 2.0626F, -4.1548F, 1.9199F, 0.0F, 0.0F));

		PartDefinition cube_r62 = chestlid.addOrReplaceChild("cube_r62",
				CubeListBuilder.create().texOffs(174, 211).addBox(-7.0538F, 9.6532F, 11.2464F, 8.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition chest = bone19.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(124, 207)
				.addBox(-7.0438F, -13.0F, 26.0332F, 8.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 14.0F, -34.0F));

		PartDefinition flag2 = partdefinition.addOrReplaceChild("flag2",
				CubeListBuilder.create().texOffs(0, 17)
						.addBox(0.1289F, -1.5F, 0.9009F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(0.1289F, -1.5F, -4.9116F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.3789F, -41.0F, -6.8384F));

		PartDefinition cube_r63 = flag2.addOrReplaceChild("cube_r63",
				CubeListBuilder.create().texOffs(10, 0).addBox(-0.006F, -1.5F, -0.0384F, 0.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3711F, 0.0F, -0.9741F, 0.0F, 0.2618F, 0.0F));

		PartDefinition cube_r64 = flag2.addOrReplaceChild("cube_r64",
		...
		PartDefinition cube_r66 = bone2.addOrReplaceChild("cube_r66",
				CubeListBuilder.create().texOffs(163, 114).addBox(-0.5F, -12.5F, -1.0F, 1.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -9.0F, -17.0F, 0.0F, -2.3562F, 0.0F));
		...
		PartDefinition cube_r67 = bone3.addOrReplaceChild(
				"cube_r67", CubeListBuilder.create().texOffs(155, 114).addBox(11.5208F, -21.5F, 11.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r68 = bone3.addOrReplaceChild(
				"cube_r68", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -16.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r69 = bone4.addOrReplaceChild(
				"cube_r69", CubeListBuilder.create().texOffs(147, 114).addBox(11.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r70 = bone4.addOrReplaceChild(
				"cube_r70", CubeListBuilder.create().texOffs(151, 114).addBox(-16.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r71 = bone5.addOrReplaceChild(
				"cube_r71", CubeListBuilder.create().texOffs(76, 106).addBox(-12.5208F, -21.5F, -13.0208F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r72 = bone5.addOrReplaceChild(
				"cube_r72", CubeListBuilder.create().texOffs(109, 0).addBox(-17.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r73 = bone5
		...
		PartDefinition cube_r74 = bone7.addOrReplaceChild("cube_r74",
				CubeListBuilder.create().texOffs(33, 106).addBox(-0.5F, -12.5F, -1.0F, 1.0F, 22.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -9.0F, -17.0F, 0.0F, -2.3562F, 0.0F));
		...
		PartDefinition cube_r75 = bone8.addOrReplaceChild(
				"cube_r75", CubeListBuilder.create().texOffs(16, 106).addBox(11.5208F, -21.5F, 11.0208F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r76 = bone8.addOrReplaceChild(
				"cube_r76", CubeListBuilder.create().texOffs(29, 106).addBox(0.15F, -21.5F, -16.9375F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r77 = bone9.addOrReplaceChild(
				"cube_r77", CubeListBuilder.create().texOffs(8, 106).addBox(11.5208F, -21.5F, -13.0208F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r78 = bone9.addOrReplaceChild(
				"cube_r78", CubeListBuilder.create().texOffs(12, 106).addBox(-16.85F, -21.5F, 0.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r79 = bone10.addOrReplaceChild(
				"cube_r79", CubeListBuilder.create().texOffs(48, 0).addBox(-12.5208F, -21.5F, -13.0208F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r80 = bone10.addOrReplaceChild(
				"cube_r80", CubeListBuilder.create().texOffs(0, 106).addBox(-17.3625F, -21.5F, -1.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r81 = bone10
				.addOrReplaceChild("cube_r81",
						CubeListBuilder.create().texOffs(4, 106).addBox(0.15F, -21.5F, 17.0625F, 1.0F, 22.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cannon = partdefinition.addOrReplaceChild("cannon",
				CubeListBuilder.create().texOffs(93, 27)
						.addBox(-2.3333F, -5.755F, -18.5032F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(92, 26).mirror()
						.addBox(1.6667F, -5.755F, -18.5032F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-0.1667F, 17.455F, -32.6718F));

		PartDefinition cube_r82 = cannon.addOrReplaceChild("cube_r82",
		...
		PartDefinition cannon2 = partdefinition.addOrReplaceChild("cannon2", CubeListBuilder.create().texOffs(93, 27)
				.addBox(2.5714F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(92, 26)
				.mirror().addBox(6.5714F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(93, 27).addBox(-28.4286F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(92, 26).mirror()
				.addBox(-24.4286F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r85 = cannon2.addOrReplaceChild("cube_r85",
				CubeListBuilder.create().texOffs(96, 134)
						.addBox(-26.5F, 1.5F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(96, 134)
						.addBox(4.5F, 1.5F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r86 = cannon2.addOrReplaceChild("cube_r86",
				CubeListBuilder.create().texOffs(104, 235)
						.addBox(-27.0F, 0.0F, -3.5F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(129, 238)
						.addBox(-27.5F, -0.5F, 2.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 235)
						.addBox(4.0F, 0.0F, -3.5F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(129, 238)
						.addBox(3.5F, -0.5F, 2.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0714F, -2.6316F, -4.6436F, -0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r87 = cannon2.addOrReplaceChild("cube_r87", CubeListBuilder.create().texOffs(36, 119)
				.mirror().addBox(-26.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(36, 119).addBox(-30.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(36, 119).mirror().addBox(4.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(36, 119).addBox(0.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0714F, 1.3684F, -3.1436F, -0.5672F, 0.0F, 0.0F));

		PartDefinition cannon3 = partdefinition.addOrReplaceChild("cannon3", CubeListBuilder.create().texOffs(93, 27)
				.mirror().addBox(-3.5714F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(92, 26)
				.addBox(-7.5714F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(93, 27)
				.mirror().addBox(27.4286F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(92, 26)
				.addBox(23.4286F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0714F, 13.6316F, -30.8564F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r88 = cannon3.addOrReplaceChild("cube_r88",
				CubeListBuilder.create().texOffs(96, 134).mirror()
						.addBox(25.5F, 1.5F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(96, 134).mirror()
						.addBox(-5.5F, 1.5F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.4286F, -3.1316F, -0.1436F, 0.829F, 0.0F, 0.0F));

		PartDefinition cube_r89 = cannon3.addOrReplaceChild("cube_r89", CubeListBuilder.create().texOffs(104, 235)
				.mirror().addBox(25.0F, 0.0F, -3.5F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(129, 238).mirror().addBox(24.5F, -0.5F, 2.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(104, 235).mirror()
				.addBox(-6.0F, 0.0F, -3.5F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(129, 238)
				.mirror().addBox(-6.5F, -0.5F, 2.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.0714F, -2.6316F, -4.6436F, -0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r90 = cannon3.addOrReplaceChild("cube_r90", CubeListBuilder.create().texOffs(36, 119)
				.addBox(25.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(36, 119).mirror()
				.addBox(29.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(36, 119)
				.addBox(-5.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(36, 119).mirror()
				.addBox(-1.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.0714F, 1.3684F, -3.1436F, -0.5672F, 0.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(96, 58)
				.addBox(-1.5F, -2.625F, -43.5F, 3.0F, 2.0F, 54.0F, new CubeDeformation(0.0F)).texOffs(60, 2)
				.addBox(-4.5F, -3.0F, -43.5F, 3.0F, 2.0F, 54.0F, new CubeDeformation(0.0F)).texOffs(132, 171)
				.addBox(4.5F, -9.0F, -16.5F, 3.0F, 2.0F, 27.0F, new CubeDeformation(0.0F)).texOffs(39, 169)
				.addBox(7.5F, -9.0F, -43.5F, 3.0F, 2.0F, 27.0F, new CubeDeformation(0.0F)).texOffs(89, 25)
				.addBox(-4.5F, -6.0F, 10.5F, 9.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
				.addBox(-10.5F, -10.8937F, 10.5562F, 21.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 70)
				.addBox(-6.8938F, -12.1688F, 9.375F, 8.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 70)
				.addBox(-1.6062F, -12.2625F, 9.4875F, 8.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(26, 49)
				.addBox(-7.8312F, -6.025F, 10.9313F, 11.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 49)
				.addBox(-2.3375F, -7.3375F, 10.8188F, 11.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(60, 19)
				.addBox(-5.8312F, -10.125F, 10.9313F, 9.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				.addBox(-8.0F, -8.0F, -32.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(30, 16)
				.addBox(-1.0F, -17.0F, -12.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				.addBox(-0.5F, -16.5F, -10.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				.addBox(-1.0F, -8.0F, 12.0F, 2.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(65, 197)
				.addBox(12.0F, -14.0F, -43.0F, 0.0F, 4.0F, 55.0F, new CubeDeformation(0.0F)).texOffs(65, 197).mirror()
				.addBox(-12.0F, -14.0F, -43.0F, 0.0F, 4.0F, 55.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 250).addBox(-12.0F, -16.0F, 12.0F, 24.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(60, 2).mirror().addBox(1.5F, -3.0F, -43.5F, 3.0F, 2.0F, 54.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r95 = bb_main.addOrReplaceChild("cube_r95", CubeListBuilder.create().texOffs(60, 114)
		...
		PartDefinition cube_r96 = bb_main.addOrReplaceChild("cube_r96",
		...
		PartDefinition cube_r101 = bb_main.addOrReplaceChild("cube_r101",
				CubeListBuilder.create().texOffs(60, 0).mirror()
						.addBox(8.1843F, 19.6318F, -26.6504F, 3.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
						.mirror(false),
		...
		PartDefinition cube_r113 = bb_main.addOrReplaceChild("cube_r113",
		...
		PartDefinition cube_r115 = bb_main.addOrReplaceChild("cube_r115", CubeListBuilder.create().texOffs(67, 223)
		...
		PartDefinition cube_r128 = bb_main.addOrReplaceChild("cube_r128",
				CubeListBuilder.create().texOffs(89, 9).addBox(-19.7634F, -6.5126F, -25.1741F, 3.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, -19.5F, -0.077F, -0.4382F, -0.011F));

		PartDefinition cube_r129 = bb_main.addOrReplaceChild("cube_r129",
		...
		PartDefinition cube_r131 = bb_main.addOrReplaceChild("cube_r131",
		...
		PartDefinition cube_r132 = bb_main.addOrReplaceChild("cube_r132", CubeListBuilder.create().texOffs(89, 18)
		...
		PartDefinition cube_r133 = bb_main.addOrReplaceChild("cube_r133",
		...
		PartDefinition cube_r134 = bb_main.addOrReplaceChild("cube_r134", CubeListBuilder.create().texOffs(0, 139)
		...
		PartDefinition cube_r135 = bb_main.addOrReplaceChild("cube_r135",
		...
		PartDefinition cube_r137 = bb_main.addOrReplaceChild("cube_r137", CubeListBuilder.create().texOffs(30, 28)
		...
		PartDefinition cube_r151 = bb_main.addOrReplaceChild("cube_r151", CubeListBuilder.create().texOffs(72, 171)
		...
		PartDefinition cube_r152 = bb_main.addOrReplaceChild("cube_r152",
		...
		PartDefinition cube_r153 = bb_main.addOrReplaceChild("cube_r153",
		...
		PartDefinition cube_r155 = bb_main.addOrReplaceChild("cube_r155",
		...
		PartDefinition cube_r156 = bb_main.addOrReplaceChild("cube_r156", CubeListBuilder.create().texOffs(36, 175)
		...
		PartDefinition cube_r157 = bb_main.addOrReplaceChild("cube_r157",
		...
		PartDefinition cube_r158 = bb_main.addOrReplaceChild("cube_r158",
