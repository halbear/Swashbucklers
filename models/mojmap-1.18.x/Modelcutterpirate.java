...
public class Modelcutterpirate<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cutterpirate"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = flag.addOrReplaceChild("cube_r1",
		...
		PartDefinition cube_r2 = flag.addOrReplaceChild("cube_r2",
		...
		PartDefinition bone13 = partdefinition.addOrReplaceChild("bone13",
				CubeListBuilder.create().texOffs(211, 108).mirror()
						.addBox(0.0F, -62.0F, -7.0F, 0.0F, 18.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(120, 0).addBox(-0.625F, -25.0F, 32.0F, 1.0F, 1.0F, 24.0F, new CubeDeformation(0.0F))
						.texOffs(177, 169).addBox(-13.0F, -59.0F, 6.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(178, 169).addBox(-13.0F, -47.5F, 6.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(177, 169).addBox(-13.0F, -59.0F, 30.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(178, 169).addBox(-13.0F, -47.5F, 30.0F, 26.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = bone13.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(86, 227)
		...
		PartDefinition cube_r24 = bone13.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(156, 56).addBox(0.125F, -0.5F, -18.0F, 1.0F, 1.0F, 36.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.125F, -24.5F, 6.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r25 = bone13.addOrReplaceChild("cube_r25",
		...
		PartDefinition wheel = partdefinition.addOrReplaceChild("wheel", CubeListBuilder.create().texOffs(183, 222)
				...
				PartPose.offset(0.0F, 8.0F, 12.25F));

		PartDefinition mast2 = partdefinition.addOrReplaceChild("mast2", CubeListBuilder.create().texOffs(18, 16)
				.addBox(-0.75F, -57.0F, -18.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 14.0F, 28.0F));
		...
		PartDefinition cube_r27 = bone11.addOrReplaceChild(
				"cube_r27", CubeListBuilder.create().texOffs(155, 114).addBox(7.9853F, -21.5F, 7.4853F, 1.0F, 18.0F,
		...
		PartDefinition cube_r28 = bone11.addOrReplaceChild(
				"cube_r28", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -11.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = bone12.addOrReplaceChild(
				"cube_r29", CubeListBuilder.create().texOffs(147, 114).addBox(7.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r30 = bone12.addOrReplaceChild(
				"cube_r30", CubeListBuilder.create().texOffs(151, 114).addBox(-11.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r31 = bone14.addOrReplaceChild(
				"cube_r31", CubeListBuilder.create().texOffs(76, 106).addBox(-8.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r32 = bone14.addOrReplaceChild(
				"cube_r32", CubeListBuilder.create().texOffs(109, 0).addBox(-12.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r35 = bone21.addOrReplaceChild(
				"cube_r35", CubeListBuilder.create().texOffs(155, 114).addBox(7.9853F, -21.5F, 7.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r36 = bone21.addOrReplaceChild(
				"cube_r36", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -11.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r37 = bone22.addOrReplaceChild(
				"cube_r37", CubeListBuilder.create().texOffs(147, 114).addBox(7.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r38 = bone22.addOrReplaceChild(
				"cube_r38", CubeListBuilder.create().texOffs(151, 114).addBox(-11.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r39 = bone23.addOrReplaceChild(
				"cube_r39", CubeListBuilder.create().texOffs(76, 106).addBox(-8.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r40 = bone23.addOrReplaceChild(
				"cube_r40", CubeListBuilder.create().texOffs(109, 0).addBox(-12.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r43 = bone25.addOrReplaceChild(
				"cube_r43", CubeListBuilder.create().texOffs(155, 114).addBox(7.9853F, -21.5F, 7.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r44 = bone25.addOrReplaceChild(
				"cube_r44", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -11.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r45 = bone26.addOrReplaceChild(
				"cube_r45", CubeListBuilder.create().texOffs(147, 114).addBox(7.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r46 = bone26.addOrReplaceChild(
				"cube_r46", CubeListBuilder.create().texOffs(151, 114).addBox(-11.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r47 = bone27.addOrReplaceChild(
				"cube_r47", CubeListBuilder.create().texOffs(76, 106).addBox(-8.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r48 = bone27.addOrReplaceChild(
				"cube_r48", CubeListBuilder.create().texOffs(109, 0).addBox(-12.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r51 = bone16.addOrReplaceChild(
				"cube_r51", CubeListBuilder.create().texOffs(16, 106).addBox(7.9853F, -21.5F, 7.4853F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r52 = bone16.addOrReplaceChild(
				"cube_r52", CubeListBuilder.create().texOffs(29, 106).addBox(0.15F, -21.5F, -11.9375F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r53 = bone17.addOrReplaceChild(
				"cube_r53", CubeListBuilder.create().texOffs(8, 106).addBox(7.9853F, -21.5F, -9.4853F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r54 = bone17.addOrReplaceChild(
				"cube_r54", CubeListBuilder.create().texOffs(12, 106).addBox(-11.85F, -21.5F, 0.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r55 = bone18.addOrReplaceChild(
				"cube_r55", CubeListBuilder.create().texOffs(48, 0).addBox(-8.9853F, -21.5F, -9.4853F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r56 = bone18.addOrReplaceChild(
				"cube_r56", CubeListBuilder.create().texOffs(0, 106).addBox(-12.3625F, -21.5F, -1.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition bone19 = partdefinition.addOrReplaceChild("bone19", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-6.0F, 10.0F, 28.0F, 0.0F, -0.6545F, 0.0F));
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(8.0F, 24.0F, 17.0F));
		...
		PartDefinition cube_r67 = bone3.addOrReplaceChild(
				"cube_r67", CubeListBuilder.create().texOffs(155, 114).addBox(7.9853F, -21.5F, 7.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r68 = bone3.addOrReplaceChild(
				"cube_r68", CubeListBuilder.create().texOffs(159, 114).addBox(0.15F, -21.5F, -11.9375F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r69 = bone4.addOrReplaceChild(
				"cube_r69", CubeListBuilder.create().texOffs(147, 114).addBox(7.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r70 = bone4.addOrReplaceChild(
				"cube_r70", CubeListBuilder.create().texOffs(151, 114).addBox(-11.85F, -21.5F, 0.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r71 = bone5.addOrReplaceChild(
				"cube_r71", CubeListBuilder.create().texOffs(76, 106).addBox(-8.9853F, -21.5F, -9.4853F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r72 = bone5.addOrReplaceChild(
				"cube_r72", CubeListBuilder.create().texOffs(109, 0).addBox(-12.3625F, -21.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r75 = bone8.addOrReplaceChild(
				"cube_r75", CubeListBuilder.create().texOffs(16, 106).addBox(7.9853F, -21.5F, 7.4853F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r76 = bone8.addOrReplaceChild(
				"cube_r76", CubeListBuilder.create().texOffs(29, 106).addBox(0.15F, -21.5F, -11.9375F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r77 = bone9.addOrReplaceChild(
				"cube_r77", CubeListBuilder.create().texOffs(8, 106).addBox(7.9853F, -21.5F, -9.4853F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r78 = bone9.addOrReplaceChild(
				"cube_r78", CubeListBuilder.create().texOffs(12, 106).addBox(-11.85F, -21.5F, 0.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r79 = bone10.addOrReplaceChild(
				"cube_r79", CubeListBuilder.create().texOffs(48, 0).addBox(-8.9853F, -21.5F, -9.4853F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r80 = bone10.addOrReplaceChild(
				"cube_r80", CubeListBuilder.create().texOffs(0, 106).addBox(-12.3625F, -21.5F, -1.0625F, 1.0F, 22.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cannon = partdefinition.addOrReplaceChild("cannon",
				...
				PartPose.offset(-0.1667F, 17.455F, -15.6718F));
		...
		PartDefinition cannon3 = partdefinition.addOrReplaceChild("cannon3", CubeListBuilder.create().texOffs(93, 27)
				.mirror().addBox(1.4286F, -0.9316F, -2.3186F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(96, 58)
				.addBox(-1.5F, -2.625F, -21.5F, 3.0F, 2.0F, 54.0F, new CubeDeformation(0.0F)).texOffs(60, 2)
				.addBox(-4.5F, -3.0F, -21.5F, 3.0F, 2.0F, 54.0F, new CubeDeformation(0.0F)).texOffs(132, 171)
				.addBox(4.5F, -9.0F, 5.5F, 3.0F, 2.0F, 27.0F, new CubeDeformation(0.0F)).texOffs(39, 169)
				.addBox(7.5F, -9.0F, -21.5F, 3.0F, 2.0F, 27.0F, new CubeDeformation(0.0F)).texOffs(89, 25)
				.addBox(-4.5F, -6.0F, 32.5F, 9.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
				.addBox(-10.5F, -10.8937F, 32.5562F, 21.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 70)
				.addBox(-6.8938F, -12.1688F, 31.375F, 8.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 70)
				.addBox(-1.6062F, -12.2625F, 31.4875F, 8.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(26, 49)
				.addBox(-7.8312F, -6.025F, 32.9313F, 11.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 49)
				.addBox(-2.3375F, -7.3375F, 32.8188F, 11.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(60, 19)
				.addBox(-5.8312F, -10.125F, 32.9313F, 9.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				.addBox(-8.0F, -8.0F, -10.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(30, 16)
				.addBox(-1.0F, -17.0F, 10.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				...
				.addBox(12.0F, -14.0F, -21.0F, 0.0F, 4.0F, 55.0F, new CubeDeformation(0.0F)).texOffs(65, 197).mirror()
				.addBox(-12.0F, -14.0F, -21.0F, 0.0F, 4.0F, 55.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 250).addBox(-12.0F, -16.0F, 34.0F, 24.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(60, 2).mirror().addBox(1.5F, -3.0F, -21.5F, 3.0F, 2.0F, 54.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r135 = bb_main.addOrReplaceChild(
				"cube_r135", CubeListBuilder.create().texOffs(30, 28).addBox(-7.2917F, -2.6468F, 30.0F, 3.0F, 4.0F,
		...
		PartDefinition cube_r140 = bb_main.addOrReplaceChild(
				"cube_r140", CubeListBuilder.create().texOffs(120, 115).addBox(-9.922F, 10.3831F, -24.014F, 2.0F, 2.0F,
		...
		PartDefinition cube_r152 = bb_main.addOrReplaceChild(
				"cube_r152", CubeListBuilder.create().texOffs(135, 174).addBox(-10.7301F, -7.6818F, -24.0F, 3.0F, 2.0F,
		...
		PartDefinition cube_r157 = bb_main
				.addOrReplaceChild("cube_r157",
