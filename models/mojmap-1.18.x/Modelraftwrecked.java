...
public class Modelraftwrecked<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "raftwrecked"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mast = partdefinition.addOrReplaceChild("mast", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-1.0F, 16.0F, 6.0F, 0.0F, 0.0F, 1.4399F));

		PartDefinition bone2 = mast.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(1.0F, -9.5F, -9.1569F));
		...
		PartDefinition bone9 = mast.addOrReplaceChild("bone9", CubeListBuilder.create().texOffs(58, 0)
				.addBox(-17.0F, -38.0F, 5.0F, 34.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(58, 0).mirror()
				.addBox(-17.0F, -20.5F, 5.0F, 34.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(36, 0)
				.addBox(-0.75F, -45.0F, 6.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, 5.0F, -6.0F));
		...
		PartDefinition cube_r11 = bone9.addOrReplaceChild("cube_r11",
		...
		PartDefinition cube_r12 = bone9.addOrReplaceChild("cube_r12",
		...
		PartDefinition bone8 = partdefinition.addOrReplaceChild("bone8", CubeListBuilder.create(),
				PartPose.offsetAndRotation(6.0F, 16.0F, 0.0F, -1.0472F, -0.6545F, 0.0F));
		...
		PartDefinition chest = bone8.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(58, 66)
				...
				PartPose.offset(3.0F, 0.0F, -28.0F));

		PartDefinition chestlid = bone8.addOrReplaceChild("chestlid", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-8.7275F, -13.6464F, 6.3834F, -2.138F, 0.0F, 0.0F));

		PartDefinition cube_r14 = chestlid.addOrReplaceChild("cube_r14",
		...
		PartDefinition cube_r15 = chestlid.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(58, 41).addBox(-15.7158F, 4.3242F, 18.2631F, 8.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(11.7275F, 11.8235F, -13.825F, 0.9905F, 0.0F, 0.0F));

		PartDefinition cube_r16 = chestlid.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(32, 30)
		...
		PartDefinition cube_r17 = chestlid.addOrReplaceChild("cube_r17",
		...
		PartDefinition cube_r18 = chestlid.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(21, 37).addBox(-15.7358F, 11.6877F, 11.0917F, 8.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(116, 36)
				.addBox(-13.75F, -9.5F, 8.0F, 28.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r19 = bb_main.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(19, 79).addBox(-0.375F, -3.0F, -4.0F, 6.0F, 0.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = bb_main.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(116, 36).addBox(-11.75F, -6.5F, 19.0F, 28.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.0F, 0.0F, 0.0F, 0.0F, -0.3054F));

		PartDefinition cube_r21 = bb_main.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -2.5F, -24.0F, 5.0F, 5.0F, 48.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = bb_main.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(58, 5).addBox(-2.5F, -2.5F, -35.0F, 5.0F, 5.0F, 48.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = bb_main.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(58, 58).addBox(-0.5F, -2.5F, -24.0F, 5.0F, 5.0F, 48.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = bb_main.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(0, 106).addBox(-2.5F, -3.5F, -24.0F, 5.0F, 5.0F, 48.0F,
						new CubeDeformation(0.0F)),
