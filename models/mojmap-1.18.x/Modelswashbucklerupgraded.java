...
public class Modelswashbucklerupgraded<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "swashbucklerupgraded"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(80, 48).mirror()
		...
		PartDefinition cube_r7 = bone.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(78, 76).mirror()
		...
		PartDefinition cube_r9 = bone.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(59, 22).mirror()
		...
		PartDefinition cube_r10 = bone.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(0, 89).mirror()
		...
		PartDefinition cube_r11 = bone.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(59, 38).mirror()
		...
		PartDefinition cube_r13 = bone.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(40, 0).mirror()
				.addBox(-1.0083F, -0.6987F, -5.0843F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r20 = bone.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(28, 43).mirror()
		...
		PartDefinition cube_r24 = bone.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(40, 17).addBox(-1.0F, -0.375F, -5.5F, 2.0F, 1.0F, 15.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = bone.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(104, 44).addBox(-1.25F, -1.0F, -3.5F, 2.0F, 1.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r32 = bone.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(59, 38).addBox(-1.8054F, -1.0851F, -2.6872F, 2.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r33 = bone.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(20, 48).addBox(-2.0808F, -0.995F, -3.75F, 2.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = bone.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(40, 0).addBox(-0.9917F, -0.6987F, -5.0843F, 2.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r36 = bone.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(116, 100)
						.addBox(-1.9387F, -1.0347F, -16.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
						.texOffs(40, 90).addBox(-3.9387F, -1.0347F, 8.0F, 2.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r37 = bone.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(116, 65).addBox(-1.0F, -0.5F, -3.5F, 2.0F, 1.0F, 11.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r38 = bone.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(40, 38).addBox(-1.0F, -0.5F, -7.5F, 2.0F, 1.0F, 15.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r47 = flag.addOrReplaceChild("cube_r47",
		...
		PartDefinition cube_r48 = flag.addOrReplaceChild("cube_r48",
		...
		PartDefinition mast = partdefinition.addOrReplaceChild("mast", CubeListBuilder.create().texOffs(3, 19)
				.addBox(-0.75F, -32.0F, -6.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r54 = bone5
				.addOrReplaceChild("cube_r54",
						CubeListBuilder.create().texOffs(32, 74).addBox(-0.5F, -14.5F, -1.0F, 1.0F, 18.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r55 = bone5.addOrReplaceChild(
				"cube_r55", CubeListBuilder.create().texOffs(72, 75).addBox(-0.3625F, -14.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r56 = bone5
		...
		PartDefinition cube_r57 = bone7.addOrReplaceChild("cube_r57",
				CubeListBuilder.create().texOffs(16, 130).addBox(-0.5F, -12.5F, -1.0F, 1.0F, 18.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, -2.3562F, 0.0F));
		...
		PartDefinition cube_r58 = bone8
				.addOrReplaceChild("cube_r58",
						CubeListBuilder.create().texOffs(8, 130).addBox(-0.5F, -14.5F, -1.0F, 1.0F, 18.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r59 = bone8
		...
		PartDefinition cube_r60 = bone9
				.addOrReplaceChild("cube_r60",
						CubeListBuilder.create().texOffs(0, 130).addBox(-0.5F, -14.5F, -1.0F, 1.0F, 18.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r61 = bone9
		...
		PartDefinition cube_r62 = bone10
				.addOrReplaceChild("cube_r62",
						CubeListBuilder.create().texOffs(32, 74).addBox(-0.5F, -14.5F, -1.0F, 1.0F, 18.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r63 = bone10.addOrReplaceChild(
				"cube_r63", CubeListBuilder.create().texOffs(72, 75).addBox(-0.3625F, -14.5F, -1.0625F, 1.0F, 18.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r64 = bone10
				.addOrReplaceChild("cube_r64",
						CubeListBuilder.create().texOffs(110, 75).addBox(0.15F, -14.5F, 0.0625F, 1.0F, 18.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.0F, 1.5708F, 0.0F));

		PartDefinition water = partdefinition.addOrReplaceChild("water", CubeListBuilder.create().texOffs(139, 3)
				.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 15.0F, 6.5F));

		PartDefinition wheel = partdefinition.addOrReplaceChild("wheel", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, -4.75F));

		PartDefinition cannon = partdefinition.addOrReplaceChild("cannon", CubeListBuilder.create(),
				PartPose.offset(-0.1667F, 17.455F, -29.6718F));

		PartDefinition cube_r65 = cannon.addOrReplaceChild("cube_r65",
		...
		PartDefinition chest = partdefinition.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(154, 6)
				.addBox(-4.0F, -11.0F, 8.0F, 8.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, -21.0F));

		PartDefinition chestlid = partdefinition.addOrReplaceChild("chestlid", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 13.0F, -8.0375F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r67 = chestlid.addOrReplaceChild("cube_r67",
		...
		PartDefinition cube_r68 = chestlid.addOrReplaceChild("cube_r68",
		...
		PartDefinition cube_r69 = chestlid.addOrReplaceChild("cube_r69",
		...
		PartDefinition cube_r70 = chestlid.addOrReplaceChild("cube_r70",
		...
		PartDefinition cube_r71 = chestlid.addOrReplaceChild("cube_r71",
		...
		PartDefinition bone12 = partdefinition.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(73, 127)
						.addBox(0.0F, -37.0F, -18.0F, 0.0F, 14.0F, 22.0F, new CubeDeformation(0.0F)).texOffs(53, 88)
						.addBox(-0.625F, -23.0F, -19.0F, 1.0F, 1.0F, 23.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition bone13 = partdefinition.addOrReplaceChild("bone13",
				CubeListBuilder.create().texOffs(53, 88).mirror()
						.addBox(-0.375F, -18.0F, -4.0F, 1.0F, 1.0F, 23.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 24.0F, -39.0F));

		PartDefinition cube_r72 = bone13.addOrReplaceChild("cube_r72",
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(80, 38)
				.addBox(3.0F, -7.0F, -11.0F, 2.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 111)
				.addBox(5.0F, -7.0F, -27.0F, 2.0F, 1.0F, 18.0F, new CubeDeformation(0.0F)).texOffs(40, 9)
				.addBox(-3.0F, -5.0F, 9.0F, 6.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(80, 59)
				...
				.addBox(-0.7375F, -9.175F, 8.325F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 6)
				.addBox(-4.8875F, -5.35F, 9.2875F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 29)
				.addBox(-1.225F, -6.225F, 9.2125F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 31)
				.addBox(-3.8875F, -7.75F, 9.2875F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 17)
				.addBox(-1.0F, -14.0F, -7.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 19)
				.addBox(-0.5F, -13.5F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(109, 5)
				.addBox(-5.5F, -10.0F, 5.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(43, 34)
		...
		PartDefinition cube_r73 = bb_main.addOrReplaceChild("cube_r73",
				CubeListBuilder.create().texOffs(5, 144).mirror()
						...
						.texOffs(5, 144).addBox(-4.5F, -4.0F, 2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -7.0F, -32.0F, -0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r74 = bb_main.addOrReplaceChild("cube_r74",
				CubeListBuilder.create().texOffs(74, 37).mirror()
						.addBox(-0.0795F, 0.2452F, -0.1466F, 0.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false),
		...
		PartDefinition cube_r78 = bb_main.addOrReplaceChild("cube_r78",
				CubeListBuilder.create().texOffs(21, 135).addBox(-0.5F, -1.0F, 0.5F, 9.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r80 = bb_main.addOrReplaceChild("cube_r80",
				CubeListBuilder.create().texOffs(74, 37).addBox(0.0795F, 0.2452F, -0.1466F, 0.0F, 24.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -31.25F, -19.5F, -0.0174F, 0.0015F, -0.2618F));
		...
		PartDefinition cube_r82 = bb_main.addOrReplaceChild("cube_r82",
				CubeListBuilder.create().texOffs(20, 17).addBox(3.0F, 0.0F, -11.5F, 2.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r90 = bb_main
		...
		PartDefinition cube_r96 = bb_main.addOrReplaceChild("cube_r96",
				CubeListBuilder.create().texOffs(59, 27).addBox(-3.9347F, -3.1007F, -0.5F, 4.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -2.525F, 9.5F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r97 = bb_main.addOrReplaceChild("cube_r97",
				CubeListBuilder.create().texOffs(9, 8).addBox(-2.0F, -3.0F, -0.5F, 2.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -2.0F, 9.5F, 0.0F, 0.0F, 0.3054F));
		...
		PartDefinition cube_r99 = bb_main.addOrReplaceChild("cube_r99",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.5F, -8.0F, 2.0F, 1.0F, 16.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r101 = bb_main.addOrReplaceChild("cube_r101",
				CubeListBuilder.create().texOffs(104, 23).addBox(-1.0F, -0.5F, -8.0F, 2.0F, 1.0F, 20.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r104 = bb_main.addOrReplaceChild("cube_r104",
				CubeListBuilder.create().texOffs(106, 0).addBox(-1.0F, -0.5F, -10.0F, 2.0F, 1.0F, 20.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r108 = bb_main.addOrReplaceChild("cube_r108",
				CubeListBuilder.create().texOffs(80, 0).addBox(-1.0F, -0.5F, -9.0F, 2.0F, 1.0F, 22.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r109 = bb_main.addOrReplaceChild("cube_r109",
				CubeListBuilder.create().texOffs(0, 74).addBox(-1.0F, -0.5F, -7.0F, 2.0F, 1.0F, 14.0F,
						new CubeDeformation(0.0F)),
