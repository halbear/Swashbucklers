...
public class Modelswashbuckler<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "swashbuckler"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 74)
				.addBox(-8.5305F, 1.6607F, -16.5F, 2.0F, 1.0F, 36.0F, new CubeDeformation(0.0F)).texOffs(40, 1)
				.addBox(-10.5305F, 1.4107F, -16.5F, 2.0F, 1.0F, 36.0F, new CubeDeformation(0.0F)).texOffs(40, 1)
				.mirror().addBox(-6.5305F, 1.4107F, -16.5F, 2.0F, 1.0F, 36.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(104, 44).mirror()
		...
		PartDefinition cube_r7 = bone.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(78, 76).mirror()
				.addBox(5.2813F, 7.2554F, -16.0093F, 1.0F, 1.0F, 36.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r22 = bone.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(2.8978F, -0.2235F, -16.0F, 2.0F, 1.0F, 36.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r28 = bone.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(78, 76).addBox(-6.2813F, 7.2554F, -16.0093F, 1.0F, 1.0F, 36.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.5305F, 2.4107F, -0.5F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition cube_r36 = bone.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(116, 100)
						.addBox(-5.8278F, 2.1473F, -16.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(40, 90)
		...
		PartDefinition cube_r41 = bone.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(28, 43)
		...
		PartDefinition cube_r43 = bone.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.8978F, -0.2235F, -16.0F, 2.0F, 1.0F, 36.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.5305F, 2.4107F, -0.5F, 0.0F, 0.0F, 0.2618F));
		...
		PartDefinition cube_r44 = bone6.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(20, 8)
		...
		PartDefinition cube_r51 = bone3.addOrReplaceChild("cube_r51",
		...
		PartDefinition cube_r52 = bone4.addOrReplaceChild("cube_r52",
		...
		PartDefinition cube_r53 = bone4.addOrReplaceChild("cube_r53",
		...
		PartDefinition cube_r56 = bone5.addOrReplaceChild("cube_r56",
		...
		PartDefinition water = partdefinition.addOrReplaceChild("water", CubeListBuilder.create().texOffs(139, 3)
				...
				PartPose.offset(-4.0F, 15.0F, 16.5F));
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(80, 38)
						.addBox(3.0F, -7.0F, -1.0F, 2.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 111)
						.addBox(5.0F, -7.0F, -17.0F, 2.0F, 1.0F, 18.0F, new CubeDeformation(0.0F)).texOffs(80, 67)
						.addBox(-11.0F, -30.0F, -11.0F, 22.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(80, 65)
						.addBox(-11.0F, -18.5F, -11.0F, 22.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 9)
						.addBox(-3.0F, -5.0F, 19.0F, 6.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(80, 59)
						.addBox(-7.0F, -8.2625F, 19.0375F, 14.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 27)
						.addBox(-4.2625F, -9.1125F, 18.25F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 13)
						.addBox(-0.7375F, -9.175F, 18.325F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 6)
						.addBox(-4.8875F, -5.35F, 19.2875F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 29)
						.addBox(-1.225F, -6.225F, 19.2125F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 31)
						.addBox(-3.8875F, -7.75F, 19.2875F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 19)
						.addBox(-0.75F, -36.0F, -9.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 17)
		...
		PartDefinition cube_r57 = bb_main.addOrReplaceChild("cube_r57",
				CubeListBuilder.create().texOffs(80, 23).addBox(-11.0F, 19.784F, -11.2137F, 22.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r58 = bb_main.addOrReplaceChild("cube_r58",
				CubeListBuilder.create().texOffs(74, 37).mirror()
						.addBox(-8.6292F, -27.5974F, -9.119F, 0.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false),
		...
		PartDefinition cube_r61 = bb_main.addOrReplaceChild("cube_r61",
		...
		PartDefinition cube_r64 = bb_main.addOrReplaceChild("cube_r64",
				CubeListBuilder.create().texOffs(74, 37).addBox(8.6292F, -27.5974F, -9.119F, 0.0F, 24.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, -0.0174F, 0.0015F, -0.2618F));
		...
		PartDefinition cube_r73 = bb_main.addOrReplaceChild("cube_r73",
				CubeListBuilder.create().texOffs(116, 89).addBox(-1.0F, -3.8612F, -25.792F, 2.0F, 1.0F, 10.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r74 = bb_main.addOrReplaceChild("cube_r74",
				CubeListBuilder.create().texOffs(40, 33)
						...
						.addBox(4.5992F, -7.2446F, 20.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r75 = bb_main.addOrReplaceChild("cube_r75",
				CubeListBuilder.create().texOffs(40, 38)
						...
						.addBox(-6.5992F, -7.2446F, 20.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.0F, 0.0F, -0.2618F));
		...
		PartDefinition cube_r77 = bb_main.addOrReplaceChild("cube_r77",
				CubeListBuilder.create().texOffs(25, 59).addBox(3.8415F, 0.0636F, 20.0F, 4.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r78 = bb_main.addOrReplaceChild("cube_r78",
				CubeListBuilder.create().texOffs(59, 27).addBox(-7.8415F, 0.0636F, 20.0F, 4.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition cube_r80 = bb_main.addOrReplaceChild("cube_r80",
				CubeListBuilder.create().texOffs(80, 27).addBox(-11.0F, -20.7822F, -2.2923F, 22.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r81 = bb_main.addOrReplaceChild("cube_r81",
				CubeListBuilder.create().texOffs(80, 29).addBox(-11.0F, -21.4738F, -7.5942F, 22.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r82 = bb_main.addOrReplaceChild("cube_r82",
				CubeListBuilder.create().texOffs(80, 31).addBox(-11.0F, -23.4762F, -15.1675F, 22.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, -0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r83 = bb_main.addOrReplaceChild("cube_r83",
				CubeListBuilder.create().texOffs(80, 33).addBox(-11.0F, -20.7441F, -20.7238F, 22.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r84 = bb_main.addOrReplaceChild("cube_r84",
				CubeListBuilder.create().texOffs(22, 112)
						.addBox(5.0F, -4.6832F, 2.1516F, 2.0F, 1.0F, 18.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(3.0F, -5.2765F, -15.8381F, 2.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 37)
						.addBox(-5.0F, -4.6483F, 4.151F, 2.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.0349F, 0.0F, 0.0F));

		PartDefinition cube_r85 = bb_main.addOrReplaceChild("cube_r85",
				CubeListBuilder.create().texOffs(0, 17).addBox(-7.1534F, -4.7879F, -16.0F, 2.0F, 1.0F, 16.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r87 = bb_main.addOrReplaceChild("cube_r87",
				CubeListBuilder.create().texOffs(104, 44)
						.addBox(-5.0F, -4.8946F, -16.0776F, 2.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(40, 0)
						.addBox(1.0F, -5.1738F, 3.9199F, 2.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r89 = bb_main.addOrReplaceChild("cube_r89",
				CubeListBuilder.create().texOffs(44, 113)
						.addBox(-3.0F, -5.1215F, -15.9204F, 2.0F, 1.0F, 18.0F, new CubeDeformation(0.0F)).texOffs(0, 74)
						.addBox(-1.0F, -5.1564F, -15.9201F, 2.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.0175F, 0.0F, 0.0F));
