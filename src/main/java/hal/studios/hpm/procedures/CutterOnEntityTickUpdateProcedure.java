...
public class CutterOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		Entity player = null;
		if ((world.getBlockState(new BlockPos(x, y + 0.525, z))).getBlock() instanceof LiquidBlock || (world.getBlockState(new BlockPos(x, y + 0.525, z))).getBlock() instanceof SimpleWaterloggedBlock
