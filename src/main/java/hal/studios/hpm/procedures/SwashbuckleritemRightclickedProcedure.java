...
public class SwashbuckleritemRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new SwashbucklerEntity(HpmModEntities.SWASHBUCKLER.get(), _level);
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(HpmModItems.SWASHBUCKLERITEM.get());
