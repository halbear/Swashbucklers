...
public class SwashbucklerupgradespawnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new SwashbucklerupgradedEntity(HpmModEntities.SWASHBUCKLERUPGRADED.get(), _level);
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(HpmModItems.SWASHBUCKLERUPGRADE.get());
