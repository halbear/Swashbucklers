...
public class CuttermilitarisedEntity extends PathfinderMob {
	public CuttermilitarisedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HpmModEntities.CUTTERMILITARISED.get(), world);
	}
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openGui(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(CuttermilitarisedEntity.this.getId());
