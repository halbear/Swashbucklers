...
public class SwashbucklerupgradedEntity extends PathfinderMob {
	public SwashbucklerupgradedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HpmModEntities.SWASHBUCKLERUPGRADED.get(), world);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		UpgradeddestroyedProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openGui(serverPlayer, new MenuProvider() {
					...
					public Component getDisplayName() {
						return new TextComponent("Swashbuckler upgraded");
					}
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(SwashbucklerupgradedEntity.this.getId());
						return new SwashbucklerinventoryMenu(id, inventory, packetBuffer);
					}
				}, buf -> {
