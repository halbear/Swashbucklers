...
public class CutterMilitarisedDamagedSailsEntity extends PathfinderMob {
	public CutterMilitarisedDamagedSailsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HpmModEntities.CUTTER_MILITARISED_DAMAGED_SAILS.get(), world);
	}

	public CutterMilitarisedDamagedSailsEntity(EntityType<CutterMilitarisedDamagedSailsEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		CuttermilitariseddamageProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openGui(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(CutterMilitarisedDamagedSailsEntity.this.getId());
