...
public class RaftEntity extends PathfinderMob {
	public RaftEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HpmModEntities.RAFT.get(), world);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		ShiupwreckraftspawnProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
	...
	private final ItemStackHandler inventory = new ItemStackHandler(96) {
		@Override
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openGui(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(RaftEntity.this.getId());
						return new RaftinventoryMenu(id, inventory, packetBuffer);
					}
				}, buf -> {
