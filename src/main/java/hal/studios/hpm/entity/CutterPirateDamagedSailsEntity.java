...
import hal.studios.hpm.procedures.CutterPirateRightClickedOnEntityProcedure;
...
public class CutterPirateDamagedSailsEntity extends PathfinderMob {
	public CutterPirateDamagedSailsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HpmModEntities.CUTTER_PIRATE_DAMAGED_SAILS.get(), world);
	}

	public CutterPirateDamagedSailsEntity(EntityType<CutterPirateDamagedSailsEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openGui(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(CutterPirateDamagedSailsEntity.this.getId());
		...
		CutterPirateRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
