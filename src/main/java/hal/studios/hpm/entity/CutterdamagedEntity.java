...
public class CutterdamagedEntity extends PathfinderMob {
	public CutterdamagedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HpmModEntities.CUTTERDAMAGED.get(), world);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		CutterdestroyedProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openGui(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(CutterdamagedEntity.this.getId());
